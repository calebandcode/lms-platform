      ...
      <div className="relative container mx-auto px-4 md:px-24 h-full w-full flex flex-col justify-center">
        <div className="max-w-3xl">
          ...
          <p className="text-xl text-muted-foreground/90 mb-5">
            Unlock new potential in your career with tools and insight designed to elevate your skills.
          </p>

          <Button className="px-8 py-6 mt-4 rounded-lg bg-purple-600/40 hover:bg-purple-600" variant={'outline'}>Browse Cources
          </Button>
        </div>
      </div>
    </div>
