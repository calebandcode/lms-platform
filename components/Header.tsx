...
import { BookMarkedIcon, BookOpen, BookAudio } from "lucide-react";
...
export default function Header() {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-sm border-b border-border mb-6 
