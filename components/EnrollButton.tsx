  ...
  return (
    <button
      className={`w-full rounded-lg px-6 py-3 font-medium transition-all duration-300 ease-in-out relative h-12
        ${
          isPending || !user?.id
            ? "bg-purple-600/40 hover:bg-purple-600 cursor-not-allowed hover:scale-100"
            : "text-white hover:scale-105 hover:shadow-lg hover:shadow-black/10"
        }
        bg-purple-600/40 hover:bg-purple-600
      `}
